...
namespace Cartheur.Animals.Pettable.WaveformSDK
{
    public class Digilent
    {
        ...
        [DllImport("dwf.dll", EntryPoint = "FDwfDigitalI", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
